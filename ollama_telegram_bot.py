...
async def ask_question(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Formulate prompt
        prompt = f """Based on the following knowledge entries, answer this question: "{question}"Knowledge Base: {context_text} Give a comprehensive answer based on the provided knowledge. If the knowledge base doesn't contain relevant information, say so. Include reference links to the sources that support your answer."""
        ...
        answer = result.split("Give a comprehensive answer")[1] if "Give a comprehensive answer" in result else result
...
def main() -> None:
    ...
    # Document handler for CSV upload - support both MIME type and filename extension
