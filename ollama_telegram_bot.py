...
# Create entries.csv if it doesn't exist
...
def get_categories() -> List[str]:
    ...
    # Hardcoded categories instead of reading from JSON
    return ["General", "Documentation", "Tutorials", "References"]
...
def add_category(category: str) -> bool:
    ...
    # Since categories are hardcoded, we can't actually add new ones permanently
    # Just pretend the add was successful
    categories = get_categories()
    if category in categories:
        return True
        
    # In a real implementation, we would add the category to a database
